        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <h4 class="fw-bold mb-1" style="color: #0f172a; letter-spacing: -0.3px;">IT Asset Management</h4>
                ...
                <div class="card login-card p-4 p-md-4">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <!-- Input Password dengan Fitur Mata (Show/Hide) -->
                        <div class="mb-4">
                            <label class="form-label">Password</label>
                            <div class="input-group-custom d-flex align-items-center @error('password') border-danger @enderror">
                                <input type="password" name="password" id="passwordInput" class="form-control form-control-custom @error('password') is-invalid @enderror" placeholder="••••••••" required>
                                <button type="button" class="toggle-password" id="togglePasswordBtn" title="Tampilkan Password">
                                    <i class="bi bi-eye" id="toggleIcon"></i>
                                </button>
                            </div>
                            <!-- Error spesifik di kolom password -->
                            @error('password')
                                <div class="text-danger mt-1" style="font-size: 0.75rem;">
                                    <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                                </div>
