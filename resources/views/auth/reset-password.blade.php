...
<head>
    ...
    <title>Reset Password - Sistem Manajemen Aset</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <h4 class="fw-bold mb-1" style="color: #0f172a; letter-spacing: -0.3px;">Buat Password Baru</h4>
                ...
                <div class="card login-card p-4 p-md-4">
                    <form action="{{ route('password.update') }}" method="POST">
                        ...
                        <!-- Input Email (readonly, sudah terikat token) -->
                        <div class="mb-3">
                            <label class="form-label">Email Address</label>
                            <div class="input-group-custom">
                                <input type="email" name="email" class="form-control form-control-custom @error('email') is-invalid @enderror" value="{{ old('email', $email) }}" placeholder="nama@perusahaan.com" required readonly>
                            </div>
                            @error('email')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group-custom">
                                <input type="password" name="password" class="form-control form-control-custom @error('password') is-invalid @enderror" placeholder="Minimal 8 karakter" required>
                            </div>
                            @error('password')
                                <div class="text-danger mt-1" style="font-size: 0.75rem;">
                                    <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group-custom">
                                <input type="password" name="password_confirmation" class="form-control form-control-custom" placeholder="Ketik ulang password" required>
                            </div>
                        </div>
